...
export default function OnlineChampionshipAbout() {
    ...
    return lang === "cs" ? (
        <div>
            ...
            <p>
                Online mistrovství ČR se koná každoročně na podzim a organizuje
                ho naše komunita. Vítězové nás reprezentují v následujícím
                ročníku Carcassonne Champions League.
            </p>
            <p>
                Formát pro rok 2025 bude ještě upřesněn podle zájmu, ale určitě
                se máte na co těšit a doporučujeme se zúčastnit. V roce 2024 se
                hrálo systémem každý s každým, po kterém následovalo play off
                pro čtyři nejlepší ze šesti účastníků.
            </p>
            <p>
        ...
        <div>
            ...
            <p>
                ...
                championship of multiple countries in the same season. Whenever
                applicable, all games must follow recent WTCOC and CCL rules.
            </p>
        </div>
    );
}
