...
export default function NationalChampionshipAbout() {
  return (
    <>
      ...
      <p className="pb-3">
        Mistrovství ČR v Carcassonne se koná každoročně od roku 2003 v říjnu
        jako součást festivalu Deskohraní. V roce 2020 se MČR nehrálo kvůli
        pandemii koronaviru.
      </p>
      <p className="pb-3">
        Formát MČR určují organizátoři z organizace{" "}
        <a href="https://www.duha.cz/">Duha-Děsír</a>, kteří ho upravují podle
        počtu účastníků nebo kapacity prostor.
      </p>
